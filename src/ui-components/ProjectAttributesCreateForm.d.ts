...
export declare type ProjectAttributesCreateFormInputValues = {
    racNumber?: string;
...
export declare type ProjectAttributesCreateFormValidationValues = {
...
export declare type ProjectAttributesCreateFormOverridesProps = {
    ProjectAttributesCreateFormGrid?: PrimitiveOverrideProps<GridProps>;
...
export declare type ProjectAttributesCreateFormProps = React.PropsWithChildren<{
    overrides?: ProjectAttributesCreateFormOverridesProps | undefined | null;
} & {
    clearOnSuccess?: boolean;
    onSubmit?: (fields: ProjectAttributesCreateFormInputValues) => ProjectAttributesCreateFormInputValues;
    onSuccess?: (fields: ProjectAttributesCreateFormInputValues) => void;
    onError?: (fields: ProjectAttributesCreateFormInputValues, errorMessage: string) => void;
    onChange?: (fields: ProjectAttributesCreateFormInputValues) => ProjectAttributesCreateFormInputValues;
    onValidate?: ProjectAttributesCreateFormValidationValues;
} & React.CSSProperties>;
export default function ProjectAttributesCreateForm(props: ProjectAttributesCreateFormProps): React.ReactElement;
